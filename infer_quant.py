...
import os
os.environ['HF_HOME'] = "/mnt/workspace/checkpoints/"
...
quant_path = "/mnt/workspace/checkpoints/city96/Wan2.1-T2V-14B-gguf/wan2.1-t2v-14b-Q4_K_M.gguf"
...
transformer = WanTransformer3DModel.from_single_file(quant_path, quantization_config=GGUFQuantizationConfig(compute_dtype=torch.bfloat16), torch_dtype=torch.bfloat16)
cfg = 5.0
